...
class TestMagazine:
    ...
    def test_article_titles(self):
        ...
        assert magazine_1.article_titles() == magazine_1.article_titles()
        assert magazine_2.article_titles() == magazine_2.article_titles()
        assert magazine_3.article_titles() == magazine_3.article_titles()
